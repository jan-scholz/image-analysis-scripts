...
my $usage = "$0 source_atlas target_atlas outputdir\n";
...
Spawn("minctracc $minctracc_opts -step 0.2 0.2 0.2 -simplex 1.5 -iterations 10 -lattice_diameter 0.6 0.6 0.6 -transform ${outputdir}nlin1.xfm ${outputdir}${source_base}_0.25_blur.mnc ${outputdir}${target_base}_0.25_blur.mnc ${outputdir}${nlin_3_xfm}");
